 ...
 *
 * An org invite mints an ordinary mentor invite code with `orgId` on it, so the
 * one atomic claim in api/invites/redeem.js still decides the platform role.
 * Joining the org is a consequence of that claim, not a second way to get one.
 *
